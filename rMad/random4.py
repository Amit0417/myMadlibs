def madlib():
    ...
    madlib4 = f"It was a {adj1} summer {time_of_day} when we realized that the vaccine to stop spread of the disease did not work. " \
              f"\nInstead, it produced ZOMBIES!!! They were thirsty for {body_part_plural} and the streets were lined with these monsters holding {noun_plural_1} in their hands. " \
